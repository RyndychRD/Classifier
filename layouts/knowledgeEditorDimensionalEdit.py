...
class Ui_dimensionalEdit(object):
    def setupUi(self, dimensionalEdit):
        ...
        self.check_MinValue_dimensionalEdit = QtWidgets.QCheckBox(self.layoutWidget)
        self.check_MinValue_dimensionalEdit.setObjectName("check_MinValue_dimensionalEdit")
        self.gridLayout.addWidget(self.check_MinValue_dimensionalEdit, 1, 1, 1, 1)
        ...
        self.check_MaxValue_dimensionalEdit = QtWidgets.QCheckBox(self.layoutWidget)
        self.check_MaxValue_dimensionalEdit.setObjectName("check_MaxValue_dimensionalEdit")
        self.gridLayout_2.addWidget(self.check_MaxValue_dimensionalEdit, 1, 1, 1, 1)
    ...
    def retranslateUi(self, dimensionalEdit):
        ...
        self.check_MinValue_dimensionalEdit.setText(_translate("dimensionalEdit", "Включительно"))
        self.label_2.setText(_translate("dimensionalEdit", "Введите конечное значение"))
        self.check_MaxValue_dimensionalEdit.setText(_translate("dimensionalEdit", "Включительно"))
