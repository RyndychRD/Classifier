...
class Ui_featurePossibleDefinition(object):
    def setupUi(self, featurePossibleDefinition):
        ...
        self.button_goBack_featurePossibleDefinition = QtWidgets.QPushButton(self.centralwidget)
        self.button_goBack_featurePossibleDefinition.setGeometry(QtCore.QRect(31, 361, 102, 30))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(30, 150, 221, 151))
        ...
        self.button_Ok_featurePossibleDefinition = QtWidgets.QPushButton(self.centralwidget)
        self.button_Ok_featurePossibleDefinition.setGeometry(QtCore.QRect(410, 360, 80, 30))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, featurePossibleDefinition):
        ...
        self.button_Ok_featurePossibleDefinition.setText(_translate("featurePossibleDefinition", "ОК"))
